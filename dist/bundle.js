 ...
 */
        ...
        var P = "data-server-rendered", F = ["component", "directive", "filter"],
        ...
        var z, W = "__proto__" in {}, q = "undefined" != typeof window,
            K = "undefined" != typeof WXEnvironment && !!WXEnvironment.platform,
            X = K && WXEnvironment.platform.toLowerCase(), G = q && window.navigator.userAgent.toLowerCase(),
            J = G && /msie|trident/.test(G), Z = G && G.indexOf("msie 9.0") > 0, Q = G && G.indexOf("edge/") > 0,
            Y = (G && G.indexOf("android"), G && /iphone|ipad|ipod|ios/.test(G) || "ios" === X),
            tt = (G && /chrome\/\d+/.test(G), G && /phantomjs/.test(G), G && G.match(/firefox\/(\d+)/)), et = {}.watch,
            nt = !1;
        if (q) try {
            var rt = {};
        ...
        function Ot(t, e) {
            var n;
            if (c(t) && !(t instanceof ht)) return b(t, "__ob__") && t.__ob__ instanceof At ? n = t.__ob__ : xt && !ot() && (Array.isArray(t) || l(t)) && Object.isExtensible(t) && !t._isVue && (n = new At(t)), e && n && n.vmCount++, n
        }
        ...
        function Lt(t, e, n) {
            if ("function" == typeof e && (e = e.options), function (t, e) {
                ...
                if (n) {
                    var r, o, i = {};
                    if (Array.isArray(n)) for (r = n.length; r--;) "string" == typeof (o = n[r]) && (i[x(o)] = {type: null}); else if (l(n)) for (var a in n) o = n[a], i[x(a)] = l(o) ? o : {type: o}; else 0;
                    t.props = i
                }
            }(e), function (t, e) {
                var n = t.inject;
        ...
        function Ft(t, e, n, r) {
            var o = e[t], i = !b(n, t), a = n[t], s = Bt(Boolean, o.type);
        ...
        if ("undefined" != typeof Promise && at(Promise)) {
            ...
            var Qt = 1, Yt = new MutationObserver(Jt), te = document.createTextNode(String(Qt));
            Yt.observe(te, {characterData: !0}), qt = function () {
        ...
        function ue(t) {
            return s(t) ? [gt(t)] : Array.isArray(t) ? function t(e, n) {
                var r = [];
                var c, u, l, f;
                for (c = 0; c < e.length; c++) o(u = e[c]) || "boolean" == typeof u || (l = r.length - 1, f = r[l], Array.isArray(u) ? u.length > 0 && (le((u = t(u, (n || "") + "_" + c))[0]) && le(f) && (r[l] = gt(f.text + u[0].text), u.shift()), r.push.apply(r, u)) : s(u) ? le(f) ? r[l] = gt(f.text + u) : "" !== u && r.push(gt(u)) : le(u) && le(f) ? r[l] = gt(f.text + u.text) : (a(e._isVList) && i(u.tag) && o(u.key) && i(n) && (u.key = "__vlist" + n + "_" + c + "__"), r.push(u)));
                return r
            }(t) : void 0
        }
        ...
        function je(t) {
            t._o = $e, t._n = h, t._s = v, t._l = ye, t._t = ge, t._q = N, t._i = D, t._m = xe, t._f = _e, t._k = we, t._b = Ce, t._v = gt, t._e = yt, t._u = Se, t._g = ke, t._d = Te, t._p = Ee
        }
            ...
            if (!o(t)) {
                ...
                if (c(t) && (t = l.extend(t)), "function" == typeof t) {
                    ...
                    if (a(t.options.functional)) return function (t, e, n, o, a) {
                        ...
                        if (i(u)) for (var l in u) c[l] = Ft(l, u, e || r); else i(n.attrs) && Ne(c, n.attrs), i(n.props) && Ne(c, n.props);
                        var f = new Ie(n, c, a, o, t), d = s.render.call(null, f._c, f);
        ...
        function Be(t, e, n, r, u, l) {
            return (Array.isArray(n) || s(n)) && (u = r, r = n, n = void 0), a(l) && (u = Ue), function (t, e, n, r, s) {
        ...
        !function (t) {
            t.prototype._init = function (t) {
                ...
                }(e, t) : e.$options = Lt($n(e.constructor), t || {}, e), e._renderProxy = e, e._self = e, function (t) {
        ...
        !function (t) {
            ...
            }), t.options._base = t, T(t.options.components, In), function (t) {
                t.use = function (t) {
        ...
        }), Object.defineProperty(An, "FunctionalRenderContext", {value: Ie}), An.version = "2.6.10";
        var Mn = m("style,class"), Nn = m("input,textarea,option,select,progress"),
            Dn = m("contenteditable,draggable,spellcheck"), Ln = m("events,caret,typing,plaintext-only"),
            Pn = function (t, e) {
            ...
            Rn = "http://www.w3.org/1999/xlink", Un = function (t) {
        ...
        function sr(t, e) {
            (t.data.directives || e.data.directives) && function (t, e) {
                var n, r, o, i = t === nr, a = e === nr, s = ur(t.data.directives, t.context),
                    c = ur(e.data.directives, e.context), u = [], l = [];
        ...
        function pr(t, e) {
            ...
            if (!(i(n) && !1 === n.Ctor.options.inheritAttrs || o(t.data.attrs) && o(e.data.attrs))) {
                ...
                for (r in(J || Q) && u.value !== c.value && vr(s, "value", u.value), c) o(u[r]) && (Un(r) ? s.removeAttributeNS(Rn, Bn(r)) : Dn(r) || s.removeAttribute(r))
            }
        }

        function vr(t, e, n) {
            t.tagName.indexOf("-") > -1 ? hr(t, e, n) : Fn(e) ? Hn(n) ? t.removeAttribute(e) : (n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : Dn(e) ? t.setAttribute(e, Pn(e, n)) : Un(e) ? Hn(n) ? t.removeAttributeNS(Rn, Bn(e)) : t.setAttributeNS(Rn, e, n) : hr(t, e, n)
        }
        ...
        var gr, _r = {create: yr, update: yr}, br = "__r", wr = "__c";
        ...
        function Or(t, e) {
            if (!o(t.data.on) || !o(e.data.on)) {
                ...
                }(n), ae(n, r, $r, Ar, Cr, e.context), gr = void 0
            }
        }

        var kr, Sr = {create: Or, update: Or};
        ...
        var jr = {create: Tr, update: Tr}, Ir = w(function (t) {
            var e = {}, n = /:(.+)/;
        ...
        var Dr, Lr = /^--/, Pr = /\s*!important$/, Fr = function (t, e, n) {
            if (Lr.test(e)) t.style.setProperty(e, n); else if (Pr.test(n)) t.style.setProperty(O(e), n.replace(Pr, ""), "important"); else {
                var r = Ur(e);
        ...
        function Br(t, e) {
            ...
            if (!(o(n.staticStyle) && o(n.style) && o(r.staticStyle) && o(r.style))) {
                ...
                var p = function (t, e) {
                    var n, r = {};
                    if (e) for (var o = t; o.componentInstance;) (o = o.componentInstance._vnode) && o.data && (n = Mr(o.data)) && T(r, n);
                    (n = Mr(t.data)) && T(r, n);
        ...
        var Hr = {create: Br, update: Br}, Vr = /\s+/;
        ...
        var Kr = w(function (t) {
            ...
            }), Xr = q && !Z, Gr = "transition", Jr = "animation", Zr = "transition", Qr = "transitionend",
            Yr = "animation", to = "animationend";
        ...
        function io(t, e, n) {
            ...
            if (!o) return n();
            var s = o === Gr ? Qr : to, c = 0, u = function () {
        ...
        function so(t, e) {
            var n, r = window.getComputedStyle(t), o = (r[Zr + "Delay"] || "").split(", "),
                i = (r[Zr + "Duration"] || "").split(", "), a = co(o, i), s = (r[Yr + "Delay"] || "").split(", "),
                c = (r[Yr + "Duration"] || "").split(", "), u = co(s, c), l = 0, f = 0;
        ...
        function lo(t, e) {
            ...
            if (!o(r) && !i(n._enterCb) && 1 === n.nodeType) {
                ...
                if (!k || w || "" === w) {
                    var S = k && d ? d : u, T = k && v ? v : f, E = k && p ? p : l, j = k && b || m,
                        I = k && "function" == typeof w ? w : y, M = k && C || g, N = k && x || _,
                        D = h(c($) ? $.enter : $);
                    0;
                    var P = !1 !== a && !Z, F = vo(I), R = n._enterCb = L(function () {
                        P && (oo(n, E), oo(n, T)), R.cancelled ? (P && oo(n, S), N && N(n)) : M && M(n), n._enterCb = null
                    });
                    t.data.show || se(t, "insert", function () {
                        var e = n.parentNode, r = e && e._pending && e._pending[t.key];
                        r && r.tag === t.tag && r.elm._leaveCb && r.elm._leaveCb(), I && I(n, R)
                    }), j && j(n), P && (ro(n, S), ro(n, T), no(function () {
                        oo(n, S), R.cancelled || (ro(n, E), F || (po(D) ? setTimeout(R, D) : io(n, s, R)))
        ...
        function fo(t, e) {
            ...
            if (!i(n._leaveCb)) {
                var a = r.css, s = r.type, u = r.leaveClass, l = r.leaveToClass, f = r.leaveActiveClass,
                    ...
                    g = r.duration, _ = !1 !== a && !Z, b = vo(p), w = h(c(g) ? g.leave : g);
                0;
        ...
        var mo = function (t) {
                ...
                if (t !== e) {
                    ...
                    if (a(t.isAsyncPlaceholder)) i(e.asyncFactory.resolved) ? k(t.elm, e, n) : e.isAsyncPlaceholder = !0; else if (a(e.isStatic) && a(t.isStatic) && e.key === t.key && (a(e.isCloned) || a(e.isOnce))) e.componentInstance = t.componentInstance; else {
                        ...
                        o(e.text) ? i(m) && i(y) ? m !== y && function (t, e, n, r, a) {
                            var s, c, l, d = 0, p = 0, v = e.length - 1, h = e[0], m = e[v], y = n.length - 1, g = n[0],
                                b = n[y], C = !a;
                            for (0; d <= v && p <= y;) o(h) ? h = e[++d] : o(m) ? m = e[--v] : or(h, g) ? ($(h, g, r, n, p), h = e[++d], g = n[++p]) : or(m, b) ? ($(m, b, r, n, y), m = e[--v], b = n[--y]) : or(h, b) ? ($(h, b, r, n, y), C && u.insertBefore(t, h.elm, u.nextSibling(m.elm)), h = e[++d], b = n[--y]) : or(m, g) ? ($(m, g, r, n, p), C && u.insertBefore(t, m.elm, h.elm), m = e[--v], g = n[++p]) : (o(s) && (s = ir(e, d, v)), o(c = i(g.key) ? s[g.key] : x(g, e, d, v)) ? f(g, r, t, h.elm, !1, n, p) : or(l = e[c], g) ? ($(l, g, r, n, p), e[c] = void 0, C && u.insertBefore(t, l.elm, h.elm)) : f(g, r, t, h.elm, !1, n, p), g = n[++p]);
                            d > v ? _(t, o(n[y + 1]) ? null : n[y + 1].elm, n, p, y, r) : p > y && w(0, e, d, v)
                        }(d, m, y, n, l) : i(y) ? (i(t.text) && u.setTextContent(d, ""), _(d, null, y, 0, y.length - 1, n)) : i(m) ? w(0, m, 0, m.length - 1) : i(t.text) && u.setTextContent(d, "") : t.text !== e.text && u.setTextContent(d, e.text), i(v) && i(p = v.hook) && i(p = p.postpatch) && p(t, e)
                    }
                }
            }
            ...
            return function (t, e, n, s) {
                if (!o(e)) {
                    ...
                    if (o(t)) l = !0, f(e, d); else {
                        var p = i(t.nodeType);
                        if (!p && or(t, e)) $(t, e, d, null, null, s); else {
                            if (p) {
                            ...
                            if (f(e, d, v._leaveCb ? null : m, u.nextSibling(v)), i(e.parent)) for (var y = e.parent, g = h(e); y;) {
            ...
            nodeOps: Yn, modules: [mr, _r, Sr, jr, Hr, q ? {
        ...
        var yo = {
            inserted: function (t, e, n, r) {
                ...
                }) : go(t, e, n.context), t._vOptions = [].map.call(t.options, wo)) : ("textarea" === n.tag || Qn(t.type)) && (t._vModifiers = e.modifiers, e.modifiers.lazy || (t.addEventListener("compositionstart", Co), t.addEventListener("compositionend", xo), t.addEventListener("change", xo), Z && (t.vmodel = !0)))
            }, componentUpdated: function (t, e, n) {
                if ("select" === n.tag) {
                    go(t, e, n.context);
                    var r = t._vOptions, o = t._vOptions = [].map.call(t.options, wo);
        ...
        function _o(t, e, n) {
            ...
            if (!o || Array.isArray(r)) {
                for (var i, a, s = 0, c = t.options.length; s < c; s++) if (a = t.options[s], o) i = D(r, wo(a)) > -1, a.selected !== i && (a.selected = i); else if (N(wo(a), r)) return void (t.selectedIndex !== s && (t.selectedIndex = s));
                o || (t.selectedIndex = -1)
            }
        }
        ...
        var Oo = {
            model: yo, show: {
                bind: function (t, e, n) {
                    var r = e.value, o = (n = Ao(n)).data && n.data.transition,
        ...
        var jo = function (t) {
            ...
            name: "transition", props: ko, abstract: !0, render: function (t) {
                ...
                if (n && (n = n.filter(jo)).length) {
                    ...
                    var c = (i.data || (i.data = {})).transition = To(this), u = this._vnode, l = So(u);
        ...
        var Fo = {
            Transition: Mo, TransitionGroup: {
                props: No, beforeMount: function () {
                    ...
                    t.length && this.hasMove(t[0].elm, e) && (t.forEach(Do), t.forEach(Lo), t.forEach(Po), this._reflow = document.body.offsetHeight, t.forEach(function (t) {
                        if (t.data.moved) {
    ...
    }).call(this, n(0), n(10).setImmediate)
}, function (t, e, n) {
    var r = n(5);
    "string" == typeof r && (r = [[t.i, r, ""]]), r.locals && (t.exports = r.locals);
    (0, n(14).default)("d17837a0", r, !1, {})
}, function (t, e, n) {
    e = t.exports = n(1)(!1);
    var r = n(6)(n(2));
    ...
    function c(t, e) {
        for (var n = 0; n < t.length; n++) {
            ...
            if (i) {
                ...
                for (var s = []; a < r.parts.length; a++) s.push(h(r.parts[a], e));
    ...
    function h(t, e) {
        ...
        if (e.singleton) {
            var i = v++;
            n = p || (p = u(e)), r = d.bind(null, n, i, !1), o = d.bind(null, n, i, !0)
        } else n = u(e), r = function (t, e, n) {
    ...
    var r = n(3), o = function () {
        ...
        return (this._self._c || t)("div", {attrs: {id: "textClass"}}, [this._v(this._s(this.text))])
    };
    o._withStripped = !0;
    ...
    }({name: "app", data: () => ({text: "我是一个text！"})}, o, [], !1, null, "5ef48958", null);
    i.options.__file = "src/app.vue";
    var a = i.exports;
    n(4), n(2), n(7);
    const s = document.createElement("div");
    document.body.appendChild(s), new r.a({render: t => t(a)}).$mount(s)
}, function (t, e, n) {
    "use strict";
